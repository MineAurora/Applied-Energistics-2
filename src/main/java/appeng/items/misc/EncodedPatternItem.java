...
public class EncodedPatternItem extends AEBaseItem implements ICraftingPatternItem {
    ...
    public void addInformation(final ItemStack stack, final World world, final List<ITextComponent> lines,
        ...
        final ICraftingPatternDetails details = AEApi.instance().crafting().getPattern(stack, world);
    ...
    public ItemStack getOutput(final ItemStack item) {
        ...
        final ICraftingPatternDetails details = AEApi.instance().crafting().getPattern(item, w);
